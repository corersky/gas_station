...
import gas.achartengine.renderer.SimpleSeriesRenderer;
...
public class LineChart extends XYChart {
  ...
  public void drawSeries(Canvas canvas, Paint paint, float[] points,
    ...
    if (renderer.isFillBelowLine()) {
    	...
    	paint1.setColor(renderer.getFillBelowLineColor());
    	//实现线状图阴影渐变色
    	int[] gradientColors = seriesRenderer.getColors();
        float[] gradientPositions = {0.0f ,0.7f};
    	LinearGradient gradient = new LinearGradient(0, yAxisValue, 0, 0, gradientColors , gradientPositions , TileMode.CLAMP);
    	...
    	drawPath(canvas, fillPoints, paint1, true);
    }
