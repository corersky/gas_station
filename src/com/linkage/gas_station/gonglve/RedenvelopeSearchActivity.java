	...
	public void showShare(final String seqId) {
		...
		gonglve_yixin_pengyou_share.setOnClickListener(new ImageView.OnClickListener() {
			...
			public void onClick(View v) {
				...
				yixin.sendYixin(RedenvelopeSearchActivity.this , getIntent().getExtras().getString("activity_rule"), currentUsedUrl+getIntent().getExtras().getString("activity_url")+"?activityId="+getIntent().getExtras().getString("activityId")+"&seqId="+seqId, getIntent().getExtras().getString("activity_name"), true);
