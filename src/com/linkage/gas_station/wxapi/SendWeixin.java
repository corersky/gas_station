...
public class SendWeixin {
	...
	public String sendWeixin(Context context, String text, String url, String title, int image, boolean isFriend) {
		...
		if (wxSdkVersion >= 0x21020001) {
			...
			msg.thumbData=Util.bmpToByteArray(BitmapFactory.decodeResource(context.getResources(), image), true);
